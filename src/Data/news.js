...
export const newsData = [
  ...
  {
    image_url: cook06,
    title: "튁톡 '마라탕후루' 챌린지로 소노공마라탕 떡상",
    content: "최근 틱톡에서 가장 인기있는 주제는 단연 ‘마라탕후루’ 챌린지라 말할 수 있다. ‘마라탕후루’ 챌린지는 가수 샤이닝의 곡의 ‘넌 마치 아름다운 기적 마치 손오공과 같아’라는 가사의 부분을 춤으로 나타낸 것이다. 다른 챌린지와 다른 점은 소노공마라탕에 가서 이를 춰야 한다는 것이다.",
    stock_impact: {
      0: 500,
      2: 11000,
      3: 5000
  ...
  },
  {
    ...
    content: "최근 삼쉉이 가맹점주들을 위한 혁신적인 조치로 '간편조리 시스템'을 구축하고 있다. 이 시스템은 주문 및 조리과정을 최적화하여 가맹점 운영을 보다 효율적으로 만들어, 가맹점주들이 시간과 노력을 절약하고 매출을 증대할 수 있는 기회를 제공한다. 이로써 브랜드는 가맹점주들과의 협력을 강화하며 새로운 성장 동력을 모색하고 있다.",
    stock_impact: {
      2: 10000,
      3 : 10000,
      4 : 1000
